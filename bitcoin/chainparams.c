...
static u8 liquidv1test_fee_asset[] = {
    0x01, 0x0d, 0xc0, 0x42, 0x8c, 0xd0, 0x9f, 0x51, 0xea, 0x24, 0x89,
    0x7b, 0xc0, 0x58, 0xa8, 0x61, 0x6e, 0x38, 0xd7, 0x53, 0x81, 0x9c,
    0xd0, 0xb7, 0xe3, 0xb0, 0x78, 0x72, 0xff, 0x1c, 0xcc, 0x32, 0x25,
};
...
const struct chainparams networks[] = {
    ...
    {.network_name = "liquid-regtest",
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_TEST_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_TEST_PRIVATE},
     .is_elements = true},
    {.network_name = "liquidv1test",
     .onchain_hrp = "ert",
     .lightning_hrp = "ert",
     .bip70_name = "liquidv1test",
     .genesis_blockhash = {{{.u.u8 = {0x41, 0x73, 0xe6, 0xc5, 0x38, 0x26, 0x3a,
                        0xad, 0xe8, 0xcf, 0x9d, 0xb2, 0x85, 0xbe,
                        0xa7, 0x9f, 0xeb, 0xe3, 0xac, 0xf3, 0x41,
                        0x02, 0x0e, 0x38, 0x56, 0x31, 0x65, 0x63,
                        0xc5, 0x3f, 0xd0, 0xb5,              
                      }}}},
     .rpc_port = 18334,
     .ln_port = 29735,
     .cli = "elements-cli",
     .cli_args = "-chain=liquidv1test",
     .dust_limit = {546},
     .max_funding = AMOUNT_SAT_INIT((1 << 24) - 1),
     .max_payment = AMOUNT_MSAT_INIT(0xFFFFFFFFULL),
     .max_supply = AMOUNT_SAT_INIT(2100000000000000),
     ...
     .p2sh_version = 75,
     .testnet = true,
     .fee_asset_tag = liquidv1test_fee_asset,
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_TEST_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_TEST_PRIVATE},
     .is_elements = true},
    {.network_name = "liquid",
